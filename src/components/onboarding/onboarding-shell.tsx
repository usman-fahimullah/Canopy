...
const SHELL_CONTEXT_LABELS: Record<Shell, string> = {
  talent: "Job seeker account setup",
  coach: "Coach account setup",
  employer: "Employer account setup",
};
...
interface OnboardingShellProps {
  ...
  footer?: ReactNode;
  /** Content for the right panel (illustration, asset, etc.) */
    ...
    <div className="flex min-h-screen flex-col bg-[var(--background-default)]">
      ...
      <header className="shrink-0 border-b border-[var(--primitive-neutral-200)] bg-[var(--background-default)]">
        <div className="flex items-center justify-between">
          ...
          {/* Right: GJB logo */}
          <div className="shrink-0 px-4 py-4 sm:px-12">
          ...
          <div className="flex flex-1 flex-col px-6 py-8 sm:px-12 sm:py-12 lg:px-[72px]">
            ...
            {hasProgress && (
              <div className="mb-6 flex items-center gap-2.5">
                <CircularProgress value={progressPercent} size="sm" strokeWidth={3} />
                <span className="text-sm leading-4 text-[var(--primitive-neutral-700)]">
