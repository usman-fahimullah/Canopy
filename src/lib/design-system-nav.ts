...
export const foundationsNav: NavItem[] = [
  ...
  },
  {
    ...
    description: "Border colors, widths, styles, and radius tokens",
    children: [
      {
        id: "border-colors",
        label: "Border Colors",
        href: "/design-system/foundations/borders#border-colors-default",
      },
      {
        id: "border-width",
        label: "Border Width",
        href: "/design-system/foundations/borders#border-width",
      },
      {
        id: "border-style",
        label: "Border Style",
        href: "/design-system/foundations/borders#border-style",
      },
      {
        id: "border-radius",
        label: "Border Radius",
        href: "/design-system/foundations/borders#radius-scale",
      },
    ],
  },
  {
...
export const searchIndex: SearchItem[] = [
  ...
  },
  {
    ...
    category: "Foundations",
    href: "/design-system/foundations/borders#border-colors-default",
    keywords: ["border", "color", "default", "brand", "interactive", "status", "error", "success"],
  },
  {
    id: "border-width",
    title: "Border Width",
    category: "Foundations",
    href: "/design-system/foundations/borders#border-width",
    keywords: ["border", "width", "thickness", "thin", "thick"],
  },
  {
    id: "border-style",
    title: "Border Style",
    category: "Foundations",
    href: "/design-system/foundations/borders#border-style",
    keywords: ["border", "solid", "dashed", "dotted", "style"],
  },
  {
    id: "border-radius",
    title: "Border Radius",
    category: "Foundations",
    href: "/design-system/foundations/borders#radius-scale",
    keywords: ["radius", "rounded", "corner", "pill", "circle"],
  },
  {
    id: "motion",
    title: "Motion",
