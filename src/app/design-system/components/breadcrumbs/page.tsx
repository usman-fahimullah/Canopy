...
const breadcrumbItemProps = [
  { name: "label", type: "string", required: true, description: "Display text for the breadcrumb" },
  {
    ...
    type: "string",
    default: "undefined",
    description: "Link destination (omit for current page)",
  },
];
...
export default function BreadcrumbsPage() {
  return (
    <div className="space-y-12">
      ...
      {/* Basic Usage */}
      <ComponentCard id="basic-usage" title="Basic Usage" description="Simple breadcrumb trail">
        <CodePreview
          code={`<Breadcrumbs
  items={[
...
/>`}
      ...
      >
        <div className="space-y-6">
          <div>
            <p className="mb-2 text-caption-strong text-foreground-muted">Two levels</p>
            <Breadcrumbs items={[{ label: "Dashboard", href: "/" }, { label: "Settings" }]} />
          </div>
          <div>
            <p className="mb-2 text-caption-strong text-foreground-muted">Three levels</p>
            <Breadcrumbs
              items={[
                { label: "Jobs", href: "/jobs" },
                { label: "Solar Engineer", href: "/jobs/solar-engineer" },
          ...
          <div>
            <p className="mb-2 text-caption-strong text-foreground-muted">Four levels</p>
            <Breadcrumbs
              items={[
      ...
      >
        <div className="space-y-6">
          <div>
            <p className="mb-2 text-caption-strong text-foreground-muted">Job Pipeline</p>
            <Breadcrumbs
              items={[
                { label: "Jobs", href: "/jobs" },
          ...
          <div>
            <p className="mb-2 text-caption-strong text-foreground-muted">Candidate Profile</p>
            <Breadcrumbs
              items={[{ label: "Candidates", href: "/candidates" }, { label: "John Doe" }]}
            />
          </div>
          <div>
            <p className="mb-2 text-caption-strong text-foreground-muted">Settings</p>
            <Breadcrumbs
              items={[
                { label: "Settings", href: "/settings" },
      ...
      <ComponentCard id="props" title="Props">
        <div className="space-y-6">
          <div>
            <h4 className="mb-3 text-body-strong">Breadcrumbs</h4>
            <PropsTable props={breadcrumbsProps} />
          </div>
          <div>
            <h4 className="mb-3 text-body-strong">BreadcrumbItem</h4>
