    ...
    <div className="space-y-12">
      ...
      <div>
        ...
        <p className="max-w-2xl text-body text-foreground-muted">
          Skeleton loaders provide visual placeholders while content is loading. They improve
          perceived performance by showing the page structure before data arrives.
        </p>
      </div>

      {/* Basic Usage */}
      <ComponentCard id="basic-usage" title="Basic Usage" description="Simple skeleton placeholder">
        <CodePreview code={`<Skeleton className="h-4 w-[200px]" />`}>
          <Skeleton className="h-4 w-[200px]" />
        </CodePreview>
      </ComponentCard>

      {/* Variants */}
      <ComponentCard id="variants" title="Variants" description="Different shape variants">
        <div className="space-y-6">
          <div>
            <p className="mb-2 text-caption-strong text-foreground-muted">
              Default (rounded rectangle)
            </p>
            <Skeleton className="h-12 w-48" />
          </div>
          <div>
            <p className="mb-2 text-caption-strong text-foreground-muted">Circular</p>
            <Skeleton variant="circular" className="h-12 w-12" />
          </div>
          <div>
            <p className="mb-2 text-caption-strong text-foreground-muted">Text</p>
      ...
      {/* Animations */}
      <ComponentCard id="animations" title="Animations" description="Different animation styles">
        <div className="space-y-6">
          <div>
            <p className="mb-2 text-caption-strong text-foreground-muted">Pulse (default)</p>
            <Skeleton animation="pulse" className="h-8 w-48" />
          </div>
          <div>
            <p className="mb-2 text-caption-strong text-foreground-muted">Shimmer</p>
            <Skeleton animation="shimmer" className="h-8 w-48" />
          </div>
          <div>
            <p className="mb-2 text-caption-strong text-foreground-muted">None</p>
      ...
      {/* Skeleton Text */}
      <ComponentCard id="skeleton-text" title="Skeleton Text" description="Preset for text content">
        <CodePreview code={`<SkeletonText lines={3} />`}>
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-caption text-foreground-muted">Large</p>
          </div>
        </div>
      </ComponentCard>
      ...
      >
        <CodePreview code={`<SkeletonTable rows={3} columns={4} />`}>
      ...
      >
        <div className="space-y-8">
          <div>
            <p className="mb-3 text-caption-strong text-foreground-muted">Candidate Card Loading</p>
          ...
          <div>
            <p className="mb-3 text-caption-strong text-foreground-muted">Job List Loading</p>
      ...
      <ComponentCard id="props" title="Props">
        <div className="space-y-6">
          <div>
            <h4 className="mb-3 text-body-strong">Skeleton</h4>
            <PropsTable props={skeletonProps} />
          </div>
          <div>
            <h4 className="mb-3 text-body-strong">SkeletonText</h4>
            <PropsTable props={skeletonTextProps} />
          </div>
          <div>
            <h4 className="mb-3 text-body-strong">SkeletonAvatar</h4>
            <PropsTable props={skeletonAvatarProps} />
          </div>
          <div>
            <h4 className="mb-3 text-body-strong">SkeletonTable</h4>
