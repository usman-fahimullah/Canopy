...
const fileUploadProps = [
  { name: "accept", type: "string", default: "undefined", description: 'Accepted file types (e.g., "image/*,.pdf")' },
  ...
  { name: "onChange", type: "(files: File[]) => void", default: "undefined", description: "Callback when files change" },
  { name: "onUpload", type: "(files: File[]) => Promise<void>", default: "undefined", description: "Custom upload handler" },
  { name: "onError", type: "(error: string) => void", default: "undefined", description: "Callback on error" },
    ...
    <div className="space-y-12">
      ...
      <div>
        ...
        <p className="text-body text-foreground-muted max-w-2xl">
          FileUpload provides a drag-and-drop zone for file uploads. It supports
          file validation, progress indication, and multiple file selection.
        </p>
      </div>
      ...
      <ComponentCard
        id="basic-usage"
        title="Basic Usage"
        description="Simple file upload dropzone"
      >
        <CodePreview
          code={`<FileUpload
...
/>`}
      ...
      <ComponentCard
        id="image-upload"
        title="Image Upload"
        description="Configured for images"
      >
        <div className="max-w-md space-y-2">
      ...
      <ComponentCard
        id="sizes"
        title="Sizes"
        description="Available dropzone sizes"
      >
