    ...
    const pathways = [
      {
        ...
        description: "Learn the science and business of solar PV and thermal systems",
        courseCount: 8,
        progress: 0,
        icon: "\u2600\uFE0F",
      },
      {
        ...
        description: "Master environmental, social, and governance reporting",
        courseCount: 6,
        progress: 0,
        icon: "\uD83D\uDCC8",
      },
      ...
      },
      {
        ...
        description: "Navigate climate legislation and policy frameworks",
        courseCount: 4,
        progress: 0,
        icon: "\uD83C\uDFDB\uFE0F",
      },
      {
        ...
        description: "Sustainable design, construction, and certification",
        courseCount: 7,
        progress: 0,
        icon: "\uD83C\uDFE2",
      },
