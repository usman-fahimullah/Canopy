...
export default function CandidatesPage() {
  ...
  const filteredApplications =
    activeFilter === "All"
      ...
      : applications.filter(
          (app) =>
            getStage(app).toLowerCase() === activeFilter.toLowerCase()
        );
          ...
          {PIPELINE_STAGES.map((stage) => {
            ...
            const count =
              stage === "All"
                ...
                : applications.filter(
                    (app) =>
                      getStage(app).toLowerCase() === stage.toLowerCase()
                  ).length;
          ...
          <div className="space-y-3">
            {filteredApplications.map((app) => {
              ...
              return (
                ...
                >
                  {/* Avatar Initials */}
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[var(--primitive-blue-200)] text-[var(--primitive-blue-700)] text-caption font-bold">
                    {candidateName
                      .split(" ")
                      .map((n) => n.charAt(0))
                      .join("")
