...
function CompanyProfileSection({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-[16px] border border-[var(--primitive-neutral-200)] bg-white p-8">
        <dl className="space-y-5 max-w-xl">
          <div>
            <dt className="text-caption font-medium text-foreground-muted mb-1">
              Company name
            </dt>
            <dd className="text-body text-foreground-default">
              {company.name || <span className="text-foreground-muted italic">Not set</span>}
            </dd>
          </div>
          ...
          <div>
            ...
            <dd className="text-body text-foreground-default">
              {company.size || <span className="text-foreground-muted italic">Not set</span>}
            </dd>
          </div>
          ...
          <div>
            ...
            <dd className="text-body text-foreground-default">
              {company.sector || <span className="text-foreground-muted italic">Not set</span>}
            </dd>
          </div>
          ...
          <div>
            ...
            <dd className="text-body text-foreground-default whitespace-pre-wrap">
              {company.description || (
                <span className="text-foreground-muted italic">No description yet</span>
              )}
            </dd>
          </div>
        </dl>
    ...
    <div className="space-y-6">
          ...
          {MOCK_TEAM.map((member) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-body-sm font-medium text-foreground-default truncate">
                  {member.name}
                </p>
      ...
      <div className="rounded-xl border border-[var(--primitive-blue-200)] bg-[var(--primitive-blue-100)] px-5 py-4">
        <p className="text-body-sm text-[var(--primitive-green-800)]">
          ...
          <Link
            href="/employer/team"
            className="font-medium underline underline-offset-2 hover:text-[var(--primitive-blue-600)] transition-colors"
          >
            Team page
          </Link>
          .
...
function PrivacyAccountSection({ onSignOut }: { onSignOut: () => void }) {
  return (
    <div className="space-y-6">
      ...
      {/* Export data */}
      <div className="rounded-[16px] border border-[var(--primitive-neutral-200)] bg-white p-8">
        <h3 className="text-body font-medium text-foreground-default mb-1">
          Export company data
        </h3>
        <p className="text-caption text-foreground-muted mb-4">
          Download a copy of all your organization data including jobs,
          candidates, and team information.
        </p>
      ...
      <div className="rounded-[16px] border border-[var(--primitive-red-200)] bg-[var(--primitive-red-100)] p-8">
        <h3 className="text-body font-medium text-[var(--primitive-red-700)] mb-1">
          Delete organization
        </h3>
        <div className="flex items-start gap-2 mb-4">
          <Warning
            size={16}
            weight="fill"
            className="text-[var(--primitive-red-600)] mt-0.5 shrink-0"
          />
          <p className="text-caption text-[var(--primitive-red-700)]">
            This will permanently delete your organization and all associated
