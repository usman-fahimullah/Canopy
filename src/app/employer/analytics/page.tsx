...
export default function AnalyticsPage() {
  ...
  return (
    <div>
      ...
      <div className="px-8 py-6 lg:px-12 space-y-8">
        {/* Stat Cards */}
        <section>
        ...
        <section>
          ...
          <div className="rounded-[16px] border border-[var(--primitive-neutral-200)] bg-white p-6">
                ...
                return (
                  <div key={stage.name} className="flex items-center gap-4">
                    ...
                    <div className="w-12 shrink-0 text-right">
                      <span className="text-caption font-semibold text-foreground-default">
                        {stage.count}
                      </span>
                    </div>
            ...
            {/* Funnel conversion */}
            <div className="mt-6 flex items-center gap-2 pt-4 border-t border-[var(--primitive-neutral-200)]">
              <ArrowDown
                size={14}
                weight="bold"
                className="text-[var(--primitive-blue-600)]"
        ...
        <section>
          ...
          <div className="rounded-[16px] border border-[var(--primitive-neutral-200)] bg-white p-6">
            ...
            {/* Total */}
            <div className="mt-6 pt-4 border-t border-[var(--primitive-neutral-200)] flex items-center justify-between">
              <span className="text-caption font-medium text-foreground-default">
                Total
              </span>
              <span className="text-caption font-semibold text-foreground-default">
                {SOURCE_BREAKDOWN.reduce((sum, s) => sum + s.count, 0)}{" "}
                candidates
              </span>
            </div>
          </div>
