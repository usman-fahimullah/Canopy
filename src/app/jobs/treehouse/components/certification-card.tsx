...
export function CertificationCard({
  ...
  return (
    <div className="flex items-start gap-4 rounded-[16px] border border-[var(--primitive-neutral-200)] bg-[var(--card-background)] p-5 shadow-card transition-shadow hover:shadow-card-hover">
      {/* Icon */}
      ...
      <div className="min-w-0 flex-1">
        <h3 className="text-body font-semibold text-[var(--primitive-green-800)]">{name}</h3>
        <p className="text-caption text-[var(--primitive-neutral-600)]">{issuer}</p>
