...
function ConnectContent() {
  ...
  function selectMentor(id: string) {
    router.push(`/talent/mentoring/connect?mentor=${id}`, { scroll: false });
  }

  function clearSelection() {
    router.push("/talent/mentoring/connect", { scroll: false });
  }
  ...
  return (
    <div>
      ...
      <div className="flex h-[calc(100vh-108px)]">
        ...
        <div
          className={`w-full lg:w-[400px] lg:shrink-0 lg:border-r border-[var(--primitive-neutral-200)] flex flex-col ${
          ...
          <div className="px-4 pt-4 pb-3">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-2xl bg-[var(--primitive-neutral-100)] py-2.5 pl-10 pr-4 text-body-sm text-[var(--foreground-default)] placeholder:text-[var(--primitive-neutral-500)] outline-none transition-colors focus:bg-[var(--primitive-neutral-0)] focus:ring-2 focus:ring-[var(--primitive-green-500)]"
              />
            </div>
          </div>
        ...
        <div
          className={`flex-1 ${
            selectedMentor ? "flex" : "hidden lg:flex"
          }`}
        >
          {selectedMentor ? (
