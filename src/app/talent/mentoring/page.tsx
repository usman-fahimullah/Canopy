      ...
      <div className="px-8 lg:px-12 py-8">
        <Tabs defaultValue="my-mentors">
          <TabsListUnderline>
            ...
            <TabsTriggerUnderline value="find-mentors">
              Find Mentors
            </TabsTriggerUnderline>
          </TabsListUnderline>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3 mb-1">
                          <p className="text-body-sm font-semibold text-[var(--primitive-green-800)] truncate">
                        ...
                        {/* Headline */}
                        <p className="text-caption text-[var(--primitive-neutral-600)] truncate mb-2">
          ...
          <TabsContent value="find-mentors">
            <div className="mt-6">
              <div className="rounded-[16px] bg-[var(--primitive-green-100)] p-8 text-center">
                ...
                />
                <p className="text-body text-[var(--primitive-green-800)] mb-4">
                  Browse available mentors and send introduction requests
                </p>
                <Link href="/talent/mentoring/connect">
