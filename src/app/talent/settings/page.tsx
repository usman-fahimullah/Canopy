        ...
        <div className="flex-1 min-w-0">
          ...
          {activeSection === "profile" && (
            <div className="space-y-6">
              ...
              <div className="rounded-[16px] border border-[var(--primitive-neutral-200)] bg-white overflow-hidden">
                {/* Avatar & name header */}
                <div className="px-6 py-6 flex items-center gap-4 border-b border-[var(--primitive-neutral-200)]">
                  <Avatar
                    size="lg"
                  ...
                  <div className="flex-1 min-w-0">
                    {!isEditing ? (
                      <>
                        <p className="text-body-strong font-semibold text-foreground-default truncate">
                ...
                {/* Email (read-only) */}
                <div className="px-6 py-4 flex items-center justify-between border-b border-[var(--primitive-neutral-200)]">
                  <div>
                    <p className="text-body-sm font-medium text-foreground-default">Email</p>
                ...
                {/* Bio */}
                <div className="px-6 py-4 border-b border-[var(--primitive-neutral-200)]">
                  <p className="text-body-sm font-medium text-foreground-default mb-1">Bio</p>
                  {!isEditing ? (
                ...
                <div className="px-6 py-4">
                  <p className="text-body-sm font-medium text-foreground-default mb-1">Location</p>
                  {!isEditing ? (
              ...
              <div className="rounded-[16px] border border-[var(--primitive-neutral-200)] bg-white divide-y divide-[var(--primitive-neutral-200)]">
                ...
                <div className="px-6 py-4">
                  <div className="flex items-start gap-3">
                    <div className="mt-0.5 p-2 rounded-lg bg-[var(--primitive-green-100)]">
                ...
                <div className="px-6 py-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-start gap-3">
                      <div className="mt-0.5 p-2 rounded-lg bg-[var(--primitive-neutral-200)]">
                ...
                <div className="px-6 py-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-start gap-3">
                      <div className="mt-0.5 p-2 rounded-lg bg-[var(--primitive-red-100)]">
                    ...
                    {!showDeleteConfirm ? (
                      ...
                      <div className="flex items-center gap-2">
                        <p className="text-caption text-[var(--primitive-red-600)] font-medium">
                          Not available yet
                        </p>
                        <Button
                          variant="ghost"
