...
export default function ProfilePage() {
  ...
  const displayHeadline =
    seeker?.headline ?? "Climate professional";
  const displayBio =
    account?.bio ??
    seeker?.summary ??
  ...
  const displaySectors =
    seeker && seeker.targetSectors.length > 0
      ? seeker.targetSectors
      : ["Not specified"];
  ...
  return (
    <div>
      ...
      <div className="px-8 py-6 lg:px-12 space-y-6">
        {/* ---- Profile Header Card -------------------------------- */}
        ...
        <div className="rounded-[16px] border border-[var(--primitive-neutral-200)] bg-white px-6 py-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-body font-bold text-[var(--foreground-default)]">
              About
            </h3>
          ...
          <p className="text-body text-[var(--foreground-muted)] leading-relaxed">
            {displayBio}
          </p>
        </div>
        ...
        <div className="rounded-[16px] border border-[var(--primitive-neutral-200)] bg-white px-6 py-6">
          ...
          {seeker && seeker.greenSkills.length > 0 && (
            <div className="mt-4 pt-4 border-t border-[var(--primitive-neutral-200)]">
          ...
          {seeker && seeker.certifications.length > 0 && (
            <div className="mt-4 pt-4 border-t border-[var(--primitive-neutral-200)]">
              <p className="text-caption font-bold text-[var(--foreground-default)] mb-3">
                Certifications
              </p>
              <div className="flex flex-wrap gap-2">
        ...
        <div className="rounded-[16px] border border-[var(--primitive-neutral-200)] bg-white px-6 py-6">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <div className="flex items-start gap-3">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[var(--primitive-green-100)]">
                <CurrencyDollar size={18} weight="fill" className="text-[var(--primitive-green-700)]" />
              </div>
              <div>
                <p className="text-caption font-bold text-[var(--foreground-default)]">
                  Salary Range
        ...
        {seeker?.yearsExperience != null && (
          <div className="rounded-[16px] border border-[var(--primitive-neutral-200)] bg-white px-6 py-6">
            <h3 className="text-body font-bold text-[var(--foreground-default)] mb-2">
              Experience
            </h3>
            <p className="text-body text-[var(--foreground-muted)]">
              {seeker.yearsExperience}{" "}
              {seeker.yearsExperience === 1 ? "year" : "years"} of experience
            </p>
          </div>
        )}
      </div>
