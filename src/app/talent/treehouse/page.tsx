...
export default function TreehousePage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch("/api/talent/treehouse");
        if (res.ok) {
    ...
    <div>
      ...
      <div className="px-8 py-8 lg:px-12">
        <Tabs defaultValue="explore">
          <TabsListUnderline>
            <TabsTriggerUnderline value="explore">
              Explore
            </TabsTriggerUnderline>
            <TabsTriggerUnderline value="my-learning">
              My Learning
            </TabsTriggerUnderline>
            <TabsTriggerUnderline value="certifications">
              Certifications
            </TabsTriggerUnderline>
          </TabsListUnderline>
          ...
          <TabsContent value="explore">
            <div className="space-y-10 pt-6">
              {/* Learning Pathways */}
              <section>
                <h2 className="text-heading-sm font-semibold text-[var(--foreground-default)] mb-4">
                  Learning Pathways
                </h2>
