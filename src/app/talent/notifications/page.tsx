                      ...
                      <button
                        ...
                        className={`w-full flex items-start gap-4 rounded-[16px] border bg-white px-6 py-4 text-left transition-colors ${
                          notif.read
                            ...
                            : "border-[var(--primitive-green-200)] bg-[var(--primitive-green-100)]/30"
                        }`}
                      >
                        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[var(--primitive-green-100)] flex-shrink-0">
                          <Icon size={20} weight="fill" className="text-[var(--primitive-green-700)]" />
                        </div>
                        ...
                        {!notif.read && (
                          <span className="h-2.5 w-2.5 rounded-full bg-[var(--primitive-green-500)] flex-shrink-0 mt-1.5" />
                        )}
                      </button>
                    );
                  })}
