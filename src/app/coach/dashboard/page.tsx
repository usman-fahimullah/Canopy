...
export default function CoachDashboardPage() {
  ...
  return (
    <div className="flex min-h-screen">
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="rounded-lg bg-[var(--primitive-yellow-100)] p-1.5">
                    <stat.icon size={16} weight="bold" className="text-[var(--primitive-yellow-600)]" />
                  </div>
                </div>
              ...
              {data.upcomingSessions.slice(0, 5).map((session) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-body font-medium text-foreground-default">
      ...
      <aside className="hidden xl:block w-[375px] flex-shrink-0 border-l border-[var(--primitive-neutral-200)] bg-white">
