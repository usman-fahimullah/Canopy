...
export default function CoachEarningsPage() {
  ...
  const thisMonthEarnings = earnings?.monthlyBreakdown?.[0]?.earnings ?? 0;
  ...
  const hasEarnings = earnings && (earnings.totalEarnings > 0 || earnings.totalSessions > 0);
        ...
        {hasEarnings ? (
          <div className="space-y-8">
                    ...
                    return (
                      <div
                        ...
                        className={`flex items-center justify-between px-6 py-4 ${
                          index < earnings.monthlyBreakdown.length - 1
                      ...
                      >
                        ...
                        <p className="text-body font-semibold text-[var(--primitive-neutral-800)]">
                          $
                          {(month.earnings / 100).toLocaleString(undefined, {
            ...
            <div className="flex items-center gap-4 rounded-[16px] border border-[var(--primitive-neutral-200)] bg-[var(--primitive-neutral-100)] px-6 py-5">
              ...
              <div className="flex-1">
                ...
                <p className="text-caption text-[var(--primitive-neutral-500)]">
                  Link your Stripe account to automatically receive earnings from coaching sessions.
                </p>
              </div>
          ...
          <div className="flex flex-col items-center justify-center rounded-[16px] border border-[var(--primitive-neutral-200)] bg-[var(--card-background)] px-8 py-16 text-center">
            ...
            <p className="mt-1 max-w-md text-caption text-[var(--primitive-neutral-500)]">
              Your earnings will appear here once you complete coaching sessions. Connect your
