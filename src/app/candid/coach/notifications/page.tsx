                      ...
                      <button
                        ...
                        className={`flex w-full items-start gap-4 rounded-[16px] border bg-[var(--card-background)] px-6 py-4 text-left transition-colors ${
                          notif.read
                            ...
                            : "bg-[var(--primitive-yellow-100)]/30 border-[var(--primitive-yellow-200)]"
                        }`}
                      >
                        <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-[var(--primitive-yellow-100)]">
                          <Icon
                            size={20}
                            weight="fill"
                        ...
                        {!notif.read && (
                          <span className="mt-1.5 h-2.5 w-2.5 flex-shrink-0 rounded-full bg-[var(--primitive-yellow-500)]" />
                        )}
                      </button>
                    );
                  })}
