...
> = {
  "no-mentors": {
    ...
    defaultDescription: "We couldn't find any mentors matching your criteria. Try adjusting your filters.",
    defaultActionLabel: "Clear filters",
    iconColor: "text-[var(--primitive-green-800)]",
    bgColor: "bg-[var(--primitive-blue-200)]",
  },
  "no-sessions": {
    icon: CalendarBlank,
    defaultTitle: "No sessions yet",
    defaultDescription: "You haven't scheduled any sessions. Connect with a mentor to get started!",
    defaultActionLabel: "Schedule a session",
    defaultActionHref: "/candid/browse",
    iconColor: "text-[var(--primitive-green-800)]",
    bgColor: "bg-[var(--primitive-blue-200)]",
  },
  "no-messages": {
    ...
    defaultDescription: "Start a conversation with your mentor to get advice and guidance.",
  ...
  "no-results": {
    ...
    defaultDescription: "We couldn't find what you're looking for. Try a different search term.",
  ...
  "no-favorites": {
    icon: "candid-symbol",
    defaultTitle: "No saved mentors",
    defaultDescription: "Save mentors you're interested in to easily find them later.",
  ...
  welcome: {
    ...
    defaultDescription: "Let's get you set up with the right mentor for your climate career journey.",
