...
async function main() {
  ...
  const finnSeeker = await prisma.seekerProfile.create({
    data: { accountId: finnAccount.id, headline: "Manufacturing Engineer | Clean Production", careerStage: CareerStage.MID_CAREER, motivations: ["finding-job", "exploring-options"], skills: ["Lean Manufacturing", "Six Sigma", "Process Optimization", "CAD/CAM"], greenSkills: ["Clean Manufacturing", "Waste Reduction", "Energy Efficiency"], certifications: ["Six Sigma Green Belt", "Lean Certified"], yearsExperience: 6, aiSummary: "Manufacturing engineer with strong continuous improvement background looking to apply lean skills to sustainable production.", targetSectors: ["manufacturing", "circular-economy"], isMentor: true, mentorBio: "Lean manufacturing veteran happy to mentor people interested in sustainable manufacturing careers.", mentorTopics: ["Sustainable Manufacturing", "Lean/Six Sigma in Green Jobs", "Manufacturing Careers"] },
  });
