...
export function PageHeader({ title, description, actions, className }: PageHeaderProps) {
  return (
    <div className={cn(
      ...
      "pb-6 border-b border-[var(--border-default)]", // ← Add visual separation
      className
    )}>
      <div>
...
<div className="flex items-center justify-center py-16">
  <div className="text-center max-w-sm">
    ...
    {/* Friendlier title */}
    <h3 className="text-heading-sm font-semibold text-foreground-default mb-2">
      No sessions yet
    </h3>
...
return (
  <PageContainer>
    ...
    {/* Toolbar - contained */}
    <div className="mb-6 flex items-center justify-between rounded-lg bg-white border border-[var(--border-default)] p-3">
...
<div className="flex flex-col items-center justify-center h-full p-8 text-center">
  ...
  <p className="text-body-strong text-foreground-default mb-1">
...
<div className="flex flex-col items-center justify-center h-full p-8 text-center bg-[var(--background-subtle)]">
...
return (
  <PageContainer>
    ...
    <div className="mb-6 rounded-xl bg-white border border-[var(--border-default)] p-4">
    ...
    <div className="flex-1 min-w-0">
      <div className="px-4 py-6 sm:px-6 lg:px-8 xl:px-10 lg:py-8 max-w-5xl mx-auto xl:mx-0">
        ...
        <section className="mb-8">
          <h2 className="text-heading-sm text-foreground-default mb-4">My Progress</h2>
          <div className="rounded-xl bg-white border border-[var(--border-default)] p-6">
...
:root {
  ...
  --candid-empty-icon-bg: linear-gradient(135deg, var(--primitive-green-100), var(--primitive-blue-100));
